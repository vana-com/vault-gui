...
// import { VaultStoreUploadPresenter, StoragePassword } from './index'
import { CarbonArrowRight } from 'components/Icons'
// import { ToastApi } from 'components/Toast'
// import { encryptAndUploadUserDataFiles, heapTrack, stripZipFiles } from "utils";
...
const VaultStoreUpload = ({ origin, moduleName }: VaultStoreUploadProps) => {
  ...
  const encryptAndUploadFiles = async (password: string) => {
    ...
    //     render: () => (
    //       <StyledToast>
    //         Successfully uploaded your {moduleName} data
    //       </StyledToast>
    //     ),
    //   });
    ...
    //   });
    //   setTimeout(
    //     () => router.push(origin || "/vault?completed-store=true"),
    //     500
    //   );
    // } catch (error) {
            ...
            <Stack tw="rounded-sm">
              ...
              <Stack tw="w-full gap-1 lg:gap-4">
                ...
                <VaultStoreUploadPresenter
                  ...
                  passwordNode={<StoragePassword name="password" />}
                />
