...
//   >
//     {children}
//     <ToastPrimitive.Arrow css={styles.arrow} />
//   </ToastPrimitive.Content>
// ));
//
...
export const ToastDemo = () => {
  ...
  return (
    <>
      ...
      <Toast open={open} onOpenChange={setOpen} css={styles.root}>
        <ToastTitle css={styles.title}>Scheduled: Catch up</ToastTitle>
        <ToastDescription asChild css={styles.description}>
