...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    getUserModulesAll(variables: GetUserModulesAllQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetUserModulesAllQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetUserModulesAllQuery>(GetUserModulesAllDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getUserModulesAll', 'query');
    },
