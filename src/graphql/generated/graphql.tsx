...
export const CreateUserModuleDocument = gql`
  ...
  createOneUserModule(
    ...
    `;
export type CreateUserModuleMutationFn = Apollo.MutationFunction<CreateUserModuleMutation, CreateUserModuleMutationVariables>;
 ...
 *   variables: {
 *      urlToData: // value for 'urlToData'
 *      moduleId: // value for 'moduleId'
 *      userId: // value for 'userId'
 *      urlNumber: // value for 'urlNumber'
 *      fileName: // value for 'fileName'
 *      fileSize: // value for 'fileSize'
 *   },
 * });
 */
export function useCreateUserModuleMutation(baseOptions?: Apollo.MutationHookOptions<CreateUserModuleMutation, CreateUserModuleMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateUserModuleMutation, CreateUserModuleMutationVariables>(CreateUserModuleDocument, options);
      }
...
export type CreateUserModuleMutationOptions = Apollo.BaseMutationOptions<CreateUserModuleMutation, CreateUserModuleMutationVariables>;
...
export const SoftDeleteUserModulesByIdDocument = gql`
  ...
  deleteManyUsersModules(
    ...
    `;
export type SoftDeleteUserModulesByIdMutationFn = Apollo.MutationFunction<SoftDeleteUserModulesByIdMutation, SoftDeleteUserModulesByIdMutationVariables>;

/**
 * __useSoftDeleteUserModulesByIdMutation__
 *
 * To run a mutation, you first call `useSoftDeleteUserModulesByIdMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSoftDeleteUserModulesByIdMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [softDeleteUserModulesByIdMutation, { data, loading, error }] = useSoftDeleteUserModulesByIdMutation({
 *   variables: {
 *      userId: // value for 'userId'
 ...
 * });
 */
export function useSoftDeleteUserModulesByIdMutation(baseOptions?: Apollo.MutationHookOptions<SoftDeleteUserModulesByIdMutation, SoftDeleteUserModulesByIdMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SoftDeleteUserModulesByIdMutation, SoftDeleteUserModulesByIdMutationVariables>(SoftDeleteUserModulesByIdDocument, options);
      }
export type SoftDeleteUserModulesByIdMutationHookResult = ReturnType<typeof useSoftDeleteUserModulesByIdMutation>;
export type SoftDeleteUserModulesByIdMutationResult = Apollo.MutationResult<SoftDeleteUserModulesByIdMutation>;
export type SoftDeleteUserModulesByIdMutationOptions = Apollo.BaseMutationOptions<SoftDeleteUserModulesByIdMutation, SoftDeleteUserModulesByIdMutationVariables>;
export const UpdateUserExternalIdDocument = gql`
  ...
  updateOneUser(pk_columns: {id: $userId}, _set: {externalId: $externalId}) {
    ...
    `;
export type UpdateUserExternalIdMutationFn = Apollo.MutationFunction<UpdateUserExternalIdMutation, UpdateUserExternalIdMutationVariables>;

/**
 * __useUpdateUserExternalIdMutation__
 *
 * To run a mutation, you first call `useUpdateUserExternalIdMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateUserExternalIdMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateUserExternalIdMutation, { data, loading, error }] = useUpdateUserExternalIdMutation({
 *   variables: {
 *      userId: // value for 'userId'
 *      externalId: // value for 'externalId'
 *   },
 * });
 */
export function useUpdateUserExternalIdMutation(baseOptions?: Apollo.MutationHookOptions<UpdateUserExternalIdMutation, UpdateUserExternalIdMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateUserExternalIdMutation, UpdateUserExternalIdMutationVariables>(UpdateUserExternalIdDocument, options);
      }
...
/**
 * __useGetUserFromExternalIdOrEmailQuery__
 *
 * To run a query within a React component, call `useGetUserFromExternalIdOrEmailQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetUserFromExternalIdOrEmailQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetUserFromExternalIdOrEmailQuery({
 *   variables: {
 *      externalId: // value for 'externalId'
 *      emailAddress: // value for 'emailAddress'
 *   },
 * });
 */
export function useGetUserFromExternalIdOrEmailQuery(baseOptions: Apollo.QueryHookOptions<GetUserFromExternalIdOrEmailQuery, GetUserFromExternalIdOrEmailQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetUserFromExternalIdOrEmailQuery, GetUserFromExternalIdOrEmailQueryVariables>(GetUserFromExternalIdOrEmailDocument, options);
      }
export function useGetUserFromExternalIdOrEmailLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetUserFromExternalIdOrEmailQuery, GetUserFromExternalIdOrEmailQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetUserFromExternalIdOrEmailQuery, GetUserFromExternalIdOrEmailQueryVariables>(GetUserFromExternalIdOrEmailDocument, options);
        }
...
/**
 * __useGetUserUuidFromExternalIdQuery__
 *
 * To run a query within a React component, call `useGetUserUuidFromExternalIdQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetUserUuidFromExternalIdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetUserUuidFromExternalIdQuery({
 *   variables: {
 *      externalId: // value for 'externalId'
 *   },
 * });
 */
export function useGetUserUuidFromExternalIdQuery(baseOptions: Apollo.QueryHookOptions<GetUserUuidFromExternalIdQuery, GetUserUuidFromExternalIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetUserUuidFromExternalIdQuery, GetUserUuidFromExternalIdQueryVariables>(GetUserUuidFromExternalIdDocument, options);
      }
export function useGetUserUuidFromExternalIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetUserUuidFromExternalIdQuery, GetUserUuidFromExternalIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetUserUuidFromExternalIdQuery, GetUserUuidFromExternalIdQueryVariables>(GetUserUuidFromExternalIdDocument, options);
        }
export type GetUserUuidFromExternalIdQueryHookResult = ReturnType<typeof useGetUserUuidFromExternalIdQuery>;
export type GetUserUuidFromExternalIdLazyQueryHookResult = ReturnType<typeof useGetUserUuidFromExternalIdLazyQuery>;
export type GetUserUuidFromExternalIdQueryResult = Apollo.QueryResult<GetUserUuidFromExternalIdQuery, GetUserUuidFromExternalIdQueryVariables>;
...
/**
 * __useGetUsersModulesFromIdsQuery__
 *
 * To run a query within a React component, call `useGetUsersModulesFromIdsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetUsersModulesFromIdsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetUsersModulesFromIdsQuery({
 *   variables: {
 ...
 * });
 */
export function useGetUsersModulesFromIdsQuery(baseOptions: Apollo.QueryHookOptions<GetUsersModulesFromIdsQuery, GetUsersModulesFromIdsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetUsersModulesFromIdsQuery, GetUsersModulesFromIdsQueryVariables>(GetUsersModulesFromIdsDocument, options);
      }
export function useGetUsersModulesFromIdsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetUsersModulesFromIdsQuery, GetUsersModulesFromIdsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetUsersModulesFromIdsQuery, GetUsersModulesFromIdsQueryVariables>(GetUsersModulesFromIdsDocument, options);
        }
export type GetUsersModulesFromIdsQueryHookResult = ReturnType<typeof useGetUsersModulesFromIdsQuery>;
export type GetUsersModulesFromIdsLazyQueryHookResult = ReturnType<typeof useGetUsersModulesFromIdsLazyQuery>;
export type GetUsersModulesFromIdsQueryResult = Apollo.QueryResult<GetUsersModulesFromIdsQuery, GetUsersModulesFromIdsQueryVariables>;
...
/**
 * __useGetVanaAdminDataQuery__
 *
 * To run a query within a React component, call `useGetVanaAdminDataQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetVanaAdminDataQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetVanaAdminDataQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetVanaAdminDataQuery(baseOptions?: Apollo.QueryHookOptions<GetVanaAdminDataQuery, GetVanaAdminDataQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetVanaAdminDataQuery, GetVanaAdminDataQueryVariables>(GetVanaAdminDataDocument, options);
      }
export function useGetVanaAdminDataLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetVanaAdminDataQuery, GetVanaAdminDataQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetVanaAdminDataQuery, GetVanaAdminDataQueryVariables>(GetVanaAdminDataDocument, options);
        }
export type GetVanaAdminDataQueryHookResult = ReturnType<typeof useGetVanaAdminDataQuery>;
export type GetVanaAdminDataLazyQueryHookResult = ReturnType<typeof useGetVanaAdminDataLazyQuery>;
export type GetVanaAdminDataQueryResult = Apollo.QueryResult<GetVanaAdminDataQuery, GetVanaAdminDataQueryVariables>;
...
/**
 * __useGetUserModulesSubscription__
 *
 * To run a query within a React component, call `useGetUserModulesSubscription` and pass it any options that fit your needs.
 * When your component renders, `useGetUserModulesSubscription` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the subscription, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetUserModulesSubscription({
 *   variables: {
 *      userId: // value for 'userId'
 *   },
 * });
 */
export function useGetUserModulesSubscription(baseOptions: Apollo.SubscriptionHookOptions<GetUserModulesSubscription, GetUserModulesSubscriptionVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useSubscription<GetUserModulesSubscription, GetUserModulesSubscriptionVariables>(GetUserModulesDocument, options);
      }
export type GetUserModulesSubscriptionHookResult = ReturnType<typeof useGetUserModulesSubscription>;
export type GetUserModulesSubscriptionResult = Apollo.SubscriptionResult<GetUserModulesSubscription>;